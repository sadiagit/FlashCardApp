...
namespace FlashCard.DataModel.Migrations
{
    ...
    [Migration("20190927030759_TopicTableAdded")]
    partial class TopicTableAdded
    {
            ...
            modelBuilder.Entity("FlashCard.DataModel.Models.FlashCardType", b =>
                {
                    ...
                    b.HasData(
                        new { TypeId = "General", Description = "For general purpose" },
                        new { TypeId = "Code", Description = "For coding purpose" }
                    );
                });

            modelBuilder.Entity("FlashCard.DataModel.Models.Topic", b =>
                {
                    ...
                    b.Property<DateTime>("TopicAdded");

                    b.Property<DateTime?>("TopicLastRead");
